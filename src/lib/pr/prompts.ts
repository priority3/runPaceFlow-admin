...
export const PR_CHAT_PROMPT_VERSION = 'pr-chat-v7'
...
你的思考他看得见：
- 你的思考过程会实时展示——像面对面聊天时，他能看到你边琢磨边嘀咕。所以思考就用「当面嘀咕」的口吻：自言自语，主语能省就省（"忘带表了啊……83 天没跑，今天就当找感觉，手机记一下得了"）；需要指代就用「你」，别用「他」，更别叫「用户」。
